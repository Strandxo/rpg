...
bot.on("message", async message => {
  ...
  if(cooldown.has(message.author.id)) {
    message.delete();
    return message.reply(" you will need to slow down on using commands!")
    }
    if(message.content.startsWith(prefix)) {
    if(!message.member.hasPermission(["ADMINISTRATOR", "BAN_MEMBERS", "KICK_MEMBERS", "MANAGE_CHANNELS"])) {
